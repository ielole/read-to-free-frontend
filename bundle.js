...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddBook = function onAddBook(event) {
	  ...
	  api.addBook(data).then(ui.addBookSuccess).catch(ui.addBookFailure);
	};
	...
	var onDeleteReview = function onDeleteReview(event) {
	  ...
	  api.deleteReview(reviewId).then(ui.deleteReviewSuccess).catch(ui.deleteReviewFailure);
	};

	var onGetOneReview = function onGetOneReview(event) {
	  console.log('Sunday sunday sunday!');
	  event.preventDefault();
	  var reviewId = event.target.getAttribute('data-id');
	  api.getOneReview(reviewId).then(ui.getOneReviewSuccess).catch(ui.getOneReviewFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div>\n  <hr>\n  <h2><small>"
	    ...
	    + " </small></h2>\n  <h3><small>\n    <strong>Comments About the Book:</strong>\n    <br>\n    "
	    ...
	    + ">\n      Update Review "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\n  </button> -->\n  <form id=\"update-a-review\" class=\"whose-id\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n    <div class=\"form-group\">\n      <label for=\"oneReviewUserId\">User Id: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
	    + "</label>\n      <input type=\"text\" class=\"form-control\" id=\"one-review-user-id\" name=\"review[user_id]\" placeholder=\"User Id\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"oneReviewBookId\">Book Id: "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.book : stack1)) != null ? stack1.id : stack1), depth0))
	    + "</label>\n      <input type=\"text\" class=\"form-control\" id=\"one-review-book-id\" name=\"review[book_id]\" placeholder=\"Book Id\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"oneReviewComment\">Review Comments</label>\n      <input type=\"text\" class=\"form-control\" id=\"one-review-comment\" name=\"review[comment]\" placeholder=\"Updated Comments\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"oneReviewRating\">Review Rating</label>\n      <input type=\"text\"  class=\"form-control\" id=\"one-review-rating\" name=\"review[rating]\" placeholder=\"Updated Rating\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-secondary\">Update Review</button>\n  </form>\n  <hr>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
