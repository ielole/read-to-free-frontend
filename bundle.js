...
/***/ function(module, exports, __webpack_require__) {
	...
	var bookEvents = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddBook = function onAddBook(event) {
	  var formData = getFormFields(this);
	  event.preventDefault();
	  // console.log('this is ', this)
	  // console.log('data is ', data);
	  api.addBook(formData).then(ui.addBookSuccess).catch(ui.addBookFailure)
	  ...
	  }).then(ui.addReviewSuccess).catch(ui.addReviewFailure);
	};
	...
	var onDeleteReview = function onDeleteReview(event) {
	  ...
	  api.deleteReview(reviewId).then(ui.deleteReviewSuccess).then(function () {
	    onGetReviews();
	...
	var onUpdateOneReview = function onUpdateOneReview(event) {
	  var reviewId = event.target.getAttribute('data-id');
	  var data = getFormFields(this);
	  event.preventDefault();
	...
	var showLibrary = function showLibrary() {
	  $('.lib-books').toggle();
	...
	var onGetReviews = function onGetReviews() {
	  // console.log('maine house');
	  api.getReviews().then(ui.getReviewsSuccess).then(function () {
	...
	var onAddReview = function onAddReview(event) {
	  ...
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.addReview(data).then(ui.addReviewSuccess).catch(ui.addReviewFailure);
	};

	var onhideLibrary = function onhideLibrary(event) {
	  // console.log('hide books');
	  event.preventDefault();
	  ui.hideLibrary();
	};

	var showAddReviewForm = function showAddReviewForm() {
	  $('.add-a-review').toggle();
	...
	var onGetBooks = function onGetBooks() {
	  // console.log('bad mood');
	  api.getIndex().then(ui.getBooksSuccess).then(function () {
	...
	var onSearchBooks = function onSearchBooks(event) {
	  // console.log('Suja Rocks');
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.searchBooks(data).then(ui.searchBooksSuccess).then(function () {
	...
	var showAddBookForm = function showAddBookForm() {
	...
	var addBookHandlers = function addBookHandlers() {
	...
	module.exports = {
	  addBookHandlers: addBookHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addBook = function addBook(data) {
	  return $.ajax({
	...
	var getOneReview = function getOneReview(reviewId) {
	  return $.ajax({
	    url: config.host + '/reviews/' + reviewId,
	    method: 'GET',
	    headers: {
	...
	var updateOneReview = function updateOneReview(reviewId, data) {
	  return $.ajax({
	    url: config.host + '/reviews/' + reviewId,
	    method: 'PATCH',
	    data: data,
	...
	var searchBooks = function searchBooks(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showBooksTemplate = __webpack_require__(12);

	var showReviewsTemplate = __webpack_require__(32);

	var showSearchTemplate = __webpack_require__(33);
	...
	var hideBookshelf = function hideBookshelf() {
	  $('#show-reviews').html('');
	};
	...
	var getOneReviewFailure = function getOneReviewFailure(error) {
	...
	module.exports = {
	  ...
	  getReviewsFailure: getReviewsFailure,
	  addReviewSuccess: addReviewSuccess,
	  addReviewFailure: addReviewFailure,
	  deleteReviewSuccess: deleteReviewSuccess,
	  deleteReviewFailure: deleteReviewFailure,
	  updateOneReviewSuccess: updateOneReviewSuccess,
	  updateOneReviewFailure: updateOneReviewFailure,
	  getOneReviewSuccess: getOneReviewSuccess,
	  getOneReviewFailure: getOneReviewFailure,
	  searchBooksFailure: searchBooksFailure,
	  searchBooksSuccess: searchBooksSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"one-book-box\">\n  <hr>\n  <div class=\"book-cover\">\n  <h2><small>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\n    <br>\n    by\n    <br>\n    "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author_first_name : stack1), depth0))
	    + " "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author_last_name : stack1), depth0))
	    + " </small></h2>\n  </div>\n  <hr>\n\n  <button class=\"btn btn-default show-add-review\">Show Review Form</button>\n\n  <form class=\"add-a-review\">\n    <h4>Review: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</h4>\n    <div class=\"form-group\">\n      <input type=\"hidden\" class=\"form-control\" id=\"book-id\" name=\"review[book_id]\" value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"book-comment\">Comments</label>\n      <input type=\"text\" class=\"form-control\" id=\"book-comment\" name=\"review[comment]\" required placeholder=\"Comment\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"book-rating\">Book Rating (0 - 50)</label>\n      <input type=\"number\" min=\"0\" max=\"50\" step=\"5\" class=\"form-control\" id=\"book-rating\" name=\"review[rating]\" required placeholder=\"Rate This Book\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-secondary\">Submit</button>\n  </form>\n  <button class=\"hide-library btn btn-default\">\n      Hide Library\n  </button>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.books : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"single-review\">\n  <hr>\n  <div class=\"book-cover\">\n  <h2><small>"
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.book : stack1)) != null ? stack1.title : stack1), depth0))
	    + "\n    <br>\n    by\n    <br>\n    "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.book : stack1)) != null ? stack1.author_first_name : stack1), depth0))
	    + " "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.book : stack1)) != null ? stack1.author_last_name : stack1), depth0))
	    + " </small></h2>\n  </div>\n  <h3><small>\n    <div class=\"format-review\">\n    <strong>Your Review of "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.book : stack1)) != null ? stack1.title : stack1), depth0))
	    + ":</strong>\n    <br>\n    "
	    ...
	    + "\n  </div>\n  </small></h3>\n  <!--<button class='update-review' data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n      Update Review "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\n  </button> -->\n  <div class=\"review-form center\">\n    <form class=\"update-a-review whose-id center\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n    <!-- <div class=\"form-group\">\n      <label for=\"oneReviewUserId\">User Id: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
	    + "</label>\n      <input type=\"text\" class=\"form-control\" id=\"one-review-user-id\" name=\"review[user_id]\" value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
	    + ">\n    </div> -->\n      <div class=\"form-group left\">\n        <input type=\"hidden\" class=\"form-control\" id=\"one-review-book-id\" name=\"review[book_id]\" value="
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.book : stack1)) != null ? stack1.id : stack1), depth0))
	    + ">\n      </div>\n      <div class=\"form-group left\">\n        <label for=\"oneReviewComment\">Review Comments</label>\n        <textarea class=\"form-control\" id=\"one-review-comment\" name=\"review[comment]\" required>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "</textarea>\n      </div>\n      <div class=\"form-group left\">\n        <label for=\"oneReviewRating\">Review Rating (0 - 50)</label>\n        <input type=\"number\"  min=\"0\" max=\"50\" step=\"5\" class=\"form-control\" id=\"one-review-rating\" name=\"review[rating]\" required value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
	    + ">\n      </div>\n      <button type=\"submit\" class=\"btn btn-secondary\">Update Review</button>\n    </form>\n  </div>\n\n  <button class=\"edit-review btn btn-default\">\n      Edit Review\n  </button>\n  <button class=\"delete-review btn btn-default\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n      Delete Review\n  </button>\n  <button class=\"hide-reviews btn btn-default\">\n      Hide Bookshelf\n  </button>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"bookshelf-container\">\n  <h4 class=\"bookshelf-title\">YOUR DIGITAL BOOKSHELF</h4>\n  <p class=\"bookshelf-info\">\n  Here's the list of your Books! <br>Update your comment or rating here. <br> <span class=\"small-bookshelf-font\">You can also delete a book from your Bookshelf by deleting your review.</span>\n  </p>\n</div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.reviews : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div>\n  <hr>\n  <div class=\"book-cover\">\n  <h2><small>"
	    ...
	    + " "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author_last_name : stack1), depth0))
	    + " </small></h2>\n  </div>\n  <hr>\n\n  <form class=\"search-add-review\">\n    <h4>Add "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + " to your Bookshelf by writing a Review.</h4>\n    <div class=\"form-group\">\n      <input type=\"hidden\" class=\"form-control\" id=\"search-book-id\" name=\"review[book_id]\" value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"book-comment\">Comments</label>\n      <input type=\"text\" class=\"form-control\" id=\"search-book-comment\" name=\"review[comment]\" required placeholder=\"Comment\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"book-rating\">Book Rating (0 - 50)</label>\n      <input type=\"number\" min=\"0\" max=\"50\" step=\"5\" class=\"form-control\" id=\"search-book-rating\" name=\"review[rating]\" required placeholder=\"Rate This Book\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-secondary\">Submit</button>\n  </form>\n  <button class=\"hide-search-results\">\n      Hide Search Results\n  </button>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h4>Search Results</h4>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.books : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "ea274a1538fc76df7c8cabf84293a433.jpg";
