...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetBooks = function onGetBooks() {
	  ...
	  api.getIndex().then(ui.getBooksSuccess).catch(ui.failure);
	};

	var onGetReviews = function onGetReviews() {
	  // console.log('maine house');
	  api.getReviews().then(ui.getReviewsSuccess).catch(ui.getReviewsFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div>\n  <hr>\n  <h1> <small>"
	    ...
	    + "\n  </small></h1>\n  <button type=\"button\" class=\"btn btn-secondary\">Add book to your bookshelf</button>\n  <hr>\n</div>\n";
